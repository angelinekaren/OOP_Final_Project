...
import com.example.plannerproject.Helpers.TouchHelper;
...
public class HomeFragment extends Fragment implements OnDialogCloseListener, AdapterViewer.OnTaskListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // LinearLayoutManager: position the items & create a vertical LinearLayoutManager
        ...
        // Set adapter to the recycler view to populate items
